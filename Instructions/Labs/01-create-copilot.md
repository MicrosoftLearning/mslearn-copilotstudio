...
1. In a web browser, navigate to **Copilot Studio** at `https://copilotstudio.microsoft.com/`, signing in with your work or school account if prompted. Skip any welcome messages.
